...
/**
 * Created by Reshaud Ally on 2/8/2017.
 */
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            //Create JSON object from JSON Query
            ...
            for(int i = 0; i <= featuresArray.length(); i++){
                ...
                //Add to ArrayList
                earthquakes.add(new Earthquake(place,timeInMilliseconds,mag,url));
            }
